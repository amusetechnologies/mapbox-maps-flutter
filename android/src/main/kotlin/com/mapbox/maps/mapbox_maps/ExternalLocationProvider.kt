 ...
 * through Mapbox's location APIs on Android; `amuse_map`'s
 * `FloorSwitcherController`/puck-opacity logic handles it entirely
 * separately (see `notifyFloorChange`), unaffected by this override.
 */
